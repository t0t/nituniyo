...
Clone the git repo - `git clone git://github.com/roots/roots-sass.git` - or [download it](https://github.com/roots/roots-sass/zipball/master) and then rename the directory to the name of your theme or website.
